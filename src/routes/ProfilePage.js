  ...
  return (
    <Paper sx={{width: 700, height: 600, display: 'flex', flexDirection:'column', alignItems:'center', textAlign: 'left', fontSize: 'none'}}>
      ...
      <Typography sx={{width: '100%', padding: '0 20px 0 20px'}} variant="body2" gutterBottom>
        <b ><VerifiedUserOutlined style={{transform: "translate(0px, 7px)"}}/> Mail: </b> {username}
      </Typography>

      <Divider component="div" sx={{width: "100%"}}/>

    <Typography sx={{width: '100%', padding: '0 20px 0 20px'}} variant="body2" gutterBottom>
        <b ><PersonOutline style={{transform: "translate(0px, 7px)"}}/> Nombre: </b> sin completar 
      </Typography>

      <Divider component="div" sx={{width: "100%"}}/>

      <Typography sx={{width: '100%', padding: '0 20px 0 20px'}} variant="body2" gutterBottom>
        <b ><DescriptionOutlined style={{transform: "translate(0px, 7px)"}}/> Biografía: </b> <span>sin completar</span> 
      </Typography>

      <Divider component="body1" sx={{width: "100%"}}/>

      <Typography sx={{width: '100%', padding: '0 20px 0 20px'}} variant="body2" gutterBottom>
        <b><WorkOutline style={{transform: "translate(0px, 7px)"}}/> Ocupación: </b> <span>sin completar</span> 
      </Typography>

      <Divider component="body1" sx={{width: "100%"}}/>

      <Typography sx={{width: '100%', padding: '0 20px 0 20px'}} variant="body2" gutterBottom>
        <b ><LocationOnOutlined style={{transform: "translate(0px, 7px)"}}/> Ubicación: </b> <span>sin completar</span> 
      </Typography>
